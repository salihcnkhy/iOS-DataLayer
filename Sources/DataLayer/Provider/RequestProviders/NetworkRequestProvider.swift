...
public struct NetworkRequestProvider: URLRequestConvertible, AnyRequest {
    ...
    public init(baseUrl: String, method: HTTPMethod = .get, path: String? = nil, isAuthRequested: Bool = false, data: Encodable? = nil) {
